...
class L2NormSimilarity:
    ...
    def __call__(self, tensor1, tensor2):
        ...
        sum_of_squares = torch.sum(diff_squared)

        l2_norm = torch.sqrt(sum_of_squares)

        return l2_norm.item()
    
class PairwiseMatchingLoss(nn.Module):
    ...
    def forward(self, feature1, feature2, target):
        self._check_input_dim(feature1)
        self._check_input_dim(feature2)
        self.matcher.make_kernel(feature1)

        score = self.matcher(feature2)  # [b, b]
